  ...
  return (
    <div>
      ...
      <select
        ...
        disabled={isManaged}
        onChange={(event) => {
          api.setAdBlockMode([parseInt(event.currentTarget.value)])
        }}
      >
        <SelectButton>
  ...
  return (
    <div>
      ...
      <select
        ...
        onChange={(event) => {
          api.setHttpsUpgradeMode([parseInt(event.currentTarget.value)])
        }}
      >
        <SelectButton />
    ...
    <div>
      ...
      {showStrictMode ? (
        <select
          ...
          disabled={isManaged}
          onChange={(event) => {
            api.setFingerprintMode([parseInt(event.currentTarget.value)])
          }}
        >
          <SelectButton />
  ...
  return (
    <div>
      ...
      <select
        ...
        disabled={isManaged}
        onChange={(event) => {
          api.setCookieBlockMode([parseInt(event.currentTarget.value)])
        }}
      >
        <SelectButton />
