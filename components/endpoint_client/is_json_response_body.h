...
#ifndef BRAVE_COMPONENTS_ENDPOINT_CLIENT_IS_JSON_RESPONSE_BODY_H_
#define BRAVE_COMPONENTS_ENDPOINT_CLIENT_IS_JSON_RESPONSE_BODY_H_
...
#endif  // BRAVE_COMPONENTS_ENDPOINT_CLIENT_IS_JSON_RESPONSE_BODY_H_
