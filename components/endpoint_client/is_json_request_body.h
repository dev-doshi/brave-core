...
#ifndef BRAVE_COMPONENTS_ENDPOINT_CLIENT_IS_JSON_REQUEST_BODY_H_
#define BRAVE_COMPONENTS_ENDPOINT_CLIENT_IS_JSON_REQUEST_BODY_H_
...
template <typename T>
concept IsJSONRequestBody = requires(T t) {
  { t.ToValue() } -> std::same_as<base::DictValue>;
} && std::is_member_function_pointer_v<decltype(&T::ToValue)>;

}  // namespace endpoint_client::detail

#endif  // BRAVE_COMPONENTS_ENDPOINT_CLIENT_IS_JSON_REQUEST_BODY_H_
