...
inline constexpr auto kCollectedTypicalHistograms =
  base::MakeFixedFlatMap<std::string_view, std::optional<MetricConfig>>({
    ...
    {"Brave.AIChat.PercentChatsWithSkill", MetricConfig{.ephemeral = true}},
    {"Brave.AIChat.RateLimitStops", MetricConfig{.ephemeral = true}},
    {"Brave.AIChat.SessionDurationWithSkill", MetricConfig{.ephemeral = true}},
    {"Brave.AIChat.SkillAvgPrompts", MetricConfig{.ephemeral = true}},
    {"Brave.AIChat.SkillMonthlyPrompts", MetricConfig{.ephemeral = true}},
    {"Brave.AIChat.SkillsCount", MetricConfig{.ephemeral = true}},
    {"Brave.AIChat.SkillsEntryPoint", MetricConfig{.ephemeral = true}},
    {"Brave.AIChat.SkillsLastEngagementTime", {}},
    {"Brave.AIChat.SkillsUsed", MetricConfig{.ephemeral = true}},
    {"Brave.AIChat.SkillsWeeklySessions", MetricConfig{.ephemeral = true}},
