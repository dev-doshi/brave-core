...
TEST_F(PolkadotWalletServiceUnitTest, SignTransferExtrinsic) {
  ...
  polkadot_wallet_service->GenerateSignedTransferExtrinsic(
      ...
      uint128_t{1234}, recipient_pubkey, test_future.GetCallback());

  auto extrinsic_metadata = test_future.Take();
  EXPECT_EQ(base::HexEncodeLower(extrinsic_metadata->extrinsic()),
            kExpectedExtrinsic);
}
...
//   base::flat_map<base::DictValue, std::string_view> req_res_pairs;
//   // Our initial call to get account information so we have a usable nonce
//   for
//   // extinsic creation.
//   req_res_pairs.emplace(base::test::ParseJsonDict(
//                             R"(
...
//   // Our initial call to get the hash of the last finalized block in the
//   canon
//   // chain.
//   req_res_pairs.emplace(
//       base::test::ParseJsonDict(
...
//               "result": {
//                 "parentHash":
//                 "0x5834828e919dc0eccce83080104cc14f51f81330451bdf74bbc9bc1edba618f2",
//                 "number": "0x1c06358",
//                 "stateRoot":
//                 "0xc7ce642fe3c31724fc2808e179d807e5b0ba38a40eb5c08d98a41bd22eeeb9b5",
//                 "extrinsicsRoot":
//                 "0xba8c3f44dbde4e14831d61cb349f808f902bf4474112cf45c2c7d92bef4e754e",
//                 "digest": {
//                   "logs": [
//                     "0x0642414245b501030d0000002a92911100000000641ad61d0d848c4b374270406d092e8e5ca294e78ab6ea47d6da8ffe51e207758c49a32cac0d5d1e1ca56e4996b2136f42602debdf22478aff56b359adeadf06912cba0095e5b5abc3d7c0e03d9b628587010e6b44c6f9f40419b16bec4f5204",
//                     "0x04424545468403b61c769585188ea959dc10c9434bfa46d57e818c7f17e047c75c42b3b1389c11",
...
//   // Chained call, grab the block header using the hash of the finalized
//   head. req_res_pairs.emplace(
//       base::test::ParseJsonDict(
//           R"({"id":1,"jsonrpc":"2.0","method":"chain_getHeader","params":["46e5afe42b1ff0c40ecc18d7ff97974f3bdf5dfda1e21d779644a7ea30a97d21"]})"),
//       R"(
//             {
...
//   // Grab the block hash of whichever block header we're using for signing
//   the
//   // extrinsic. The polkadot-js algorithm selects between either the
//   finalized
//   // head or the parent of the current head. In this case, the finalized
//   block
...
//   // Test that we correctly see an error if the RPC nodes reject the
//   extrinsic.
...
//   // We opt into using a manual RunLoop here because of the limitations
//   around
...
//       uint128_t{1234}, recipient_pubkey, base::BindLambdaForTesting(
