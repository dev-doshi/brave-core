...
struct ManagedPasswordListView: View {
  ...
  @State private var showDeleteDomain: Bool = false
          ...
          ContentUnavailableView {
            Label {
              Text(Strings.Autofill.managePasswordsEmptyListTitle)
                .foregroundStyle(Color(braveSystemName: .schemesPrimary))
                .font(.title3)
            } icon: {
        ...
        Section(header: Text(Strings.Autofill.managePasswordsListHeaderTitle)) {
          ForEach(Array(viewModel.groupedCredentialList), id: \.domain) { domain, credentials in
            ...
            .alert(
              ...
              isPresented: $showDeleteDomain
            ) {
              Button(
                Strings.Autofill.managedPasswordDeleteCredentialAlertCancelActionTitle,
                role: .cancel
              ) {}
              Button(
                Strings.Autofill.managedPasswordDeleteCredentialButtonTitle,
