...
extension Strings {
  public struct Paywall {
    ...
    public static let havePromoCodeTitle = NSLocalizedString(
      ...
      comment: "Title label text for entering a promo code."
    )
    public static let redeemPromoCodeButtonTitle = NSLocalizedString(
      "paywall.redeemPromoCodeButtonTitle",
      bundle: .module,
...
extension Strings {
  public struct Autofill {
    ...
    public static let managePasswordsEmptyListDetail = NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "There are no passwords saved, you can save the first one by using the \"Add\" button.",
      comment:
